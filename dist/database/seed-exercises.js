...
async function seedExercises(dataSource) {
    ...
    const q1 = await questionRepo.save({
        ...
        type: question_entity_1.QuestionType.MULTIPLE,
        correctPoints: 30,
        wrongPoints: 5,
        bonusPoints: 10,
    });
    ...
    const q2_1 = await questionRepo.save({
        ...
        type: question_entity_1.QuestionType.SINGLE,
        correctPoints: 12,
        wrongPoints: 2,
        bonusPoints: 4,
    });
    await optionRepo.save([
        {
            ...
            errorDescription: 'HS hiểu sai yêu cầu bài toán, chọn phép cộng thay vì phép nhân',
        },
        {
            questionId: q2_1.id,
            content: '0,75 × 19',
    ...
    await optionRepo.save([
        ...
        },
        {
            ...
            errorDescription: 'HS chưa xác định được ý nghĩa của kết quả trong thực tiễn',
        },
    ]);
    ...
    await optionRepo.save([
        {
            ...
            errorDescription: 'Mỗi dây sau giảm còn 10,5 nghìn đồng, khi mua 16 dây = 168 nghìn đồng > 162 nghìn đồng ở cửa hàng B',
        },
        {
            questionId: q3_6.id,
            content: 'Cửa hàng B',
    ...
    await optionRepo.save([
        {
            ...
            errorDescription: 'HS giải thích chưa hợp lí - giá 1 dây không quyết định tổng chi phí',
        },
        {
            questionId: q3_7.id,
